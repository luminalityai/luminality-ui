...
If a name is provided (e.g., from a GitHub issue number):
...
- If starting a GitHub issue: use `<issue-number>-<short-slug>` (e.g., `123-add-feature`)
...
- Naming follows the `<issue-number>-<slug>` convention (e.g., `.worktrees/123-add-feature`)
